...
type PlexServer struct {
	...
	// Add rename format fields for different media types
	MovieFormat  string                 `json:"movie_format" db:"movie_format"`
	SeriesFormat string                 `json:"series_format" db:"series_format"`
	AnimeFormat  string                 `json:"anime_format" db:"anime_format"`
	MusicFormat  string                 `json:"music_format" db:"music_format"`
